...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->lang->line('content');?>" lang="<?php echo $this->lang->line('content');?>">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>design/js/jquery.fancybox-1.3.1.pack.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/jquery.cookie.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/RSA.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/jquery.mousewheel-3.0.2.pack.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/jquery.validationEngine.modified.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/functions.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/BigInt.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/Barrett.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/flowplayer-3.2.2.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>design/js/jquery.jparallax.js"></script>

        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>design/style.css" />
        ...
        <style>
            ...
            #sky{height: 265px; background: url(<?php echo base_url();?>design/bg_sky.jpg) repeat-x; position: absolute; top: 0; z-index: 2; overflow: hidden; width: 100%;}
            #sky #baloon{background: url(<?php echo base_url();?>design/bg_balloon.png) no-repeat 95% 0; height: 100%; width:120%; position: absolute;top: 0; z-index:7;}
			#sky #clouds-1{background: url('<?php echo base_url();?>design/pt_clouds.png') repeat-x 0 0; width: 110%;height: 100%;position: absolute;top: 0;z-index:5;}
			#sky #clouds-2{background: url('<?php echo base_url();?>design/pt_clouds.png') repeat-x 0 -265px; width: 120%;height: 100%;position: absolute;top: 0;z-index:4;}
			#sky #clouds-3{background: url('<?php echo base_url();?>design/pt_clouds.png') repeat-x 0 -530px; width: 130%;height: 100%;position: absolute;top: 0;z-index:3;}
            #sky #birds{background: url(<?php echo base_url();?>design/pt-birds.png) repeat-x; width: 120%;height: 100%;position: absolute;top: 0;z-index:6;}
        </style>
...
<?php }else{ ?><br><br><br><?php } ?>
                ...
                <div id="container">
                    <div id="sidebarWrapper">
                        ...
                        <div id="sidebar" class="clearfix">
                            <img src="<?php echo base_url();?>design/blank.gif"  id="major" width="233" height="228" alt="major">
    ...
    $('#pwLost').click(function(){
        showPasswordLost('<?php echo base_url();?>main/page/password/') ;
    ...
    function agbCheck() {
        ...
        if(document.getElementById('agb').checked != true) {
            alert("<?php echo $this->lang->line('error_order');?>");
        } else {
