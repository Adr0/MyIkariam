...
<div id="globalResources">
	...
	<li class="gold" title="<?php echo number_format($this->Player_Model->user->gold);?> <?php echo $this->lang->line('gold');?>">
            <a href="<?=$this->config->item('base_url')?>game/finances/">
                <span class="textLabel"><?=$this->lang->line('gold')?>:</span><span id="value_gold"><?php echo number_format($this->Player_Model->user->gold);?></span>
            </a>
        </li>
    </ul>
</div>

<?php $all_peoples = $this->Player_Model->peoples[$this->Player_Model->town_id];?>
