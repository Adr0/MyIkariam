...
<div id="mainview">
	<div class="buildingDescription">
		<h1>Edit Pagina Interna dell'alleanza</h1>
	</div>
        <div class="contentBox01h">
		<h3 class="header"><span class="textLabel">Pagina Interna</span></h3>
		<div class="content">
		<? 
		...
		<br><br>
		<FORM method="post" action="<?=$this->config->item('base_url')?>actions/embassy/editintpage/<?=$param2?>">
		<TEXTAREA cols=110 rows=70 WRAP="physical" name="editintpage">
		<?
		echo $param1;
		?>
